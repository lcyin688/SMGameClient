...
export class Group {
    ...
    getAll(): Array<C2FTween<UnknownProps>> {
        var _this = this;
    ...
    removeByCCObject(target: cc.Object) {
        ...
        for (let i = 0; i < tweenIds.length; i++) {
            let tween: C2FTween<any> = this._tweens[tweenIds[i]];
    ...
    update(time?: number, preserve?: boolean): boolean {
        ...
        for (var i = 0; i < tweenIds.length; i++) {
            var tween: C2FTween<any> = this._tweens[tweenIds[i]];
 ...
 */
export class C2FTween<T extends UnknownProps> {
    /** 绑定的cc.Object */
    private _ccObject;
    ...
    start(time?: number): this {
        ...
        if (time === void 0) {
            if (this._group === mainGroup) {
                time = GameTimer.gameMs;
            } else if (this._group === scaleGroup) {
                time = GameTimer.scaleGameMs;
            }
        }
    ...
    chain(...tweens: Array<C2FTween<UnknownProps>>): this {
        //@ts-ignore
        var tweens = [];
