...
// If you need add logic, please write in SevenDaySignItemView.ts .
// If you need add data, please write in SevenDaySignItemViewModel.ts .
...
@ccclass
export default class SevenDaySignItemView extends UIPanelBase {
    /** 预制名 给实例调用 */
