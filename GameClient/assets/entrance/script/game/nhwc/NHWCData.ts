...
export class NHWCData {
    ...
    /**请求颜色 */
    public reqNHWCDrawColor(color: string) {
        let cData: msg.CS_NHWCDrawColor = {
            color: color,
        };
    ...
    /**请求绘画宽度 */
    public reqNHWCDrawWidth(width: number) {
    ...
    /**请求绘画清理 */
    public reqNHWCDrawClear() {
        let cData: msg.CS_NHWCDrawClear = {};
        c2f.webSocket.send(GameMsgId.MsgId.MSG_CS_NHWCDrawClear, cData);
    }
