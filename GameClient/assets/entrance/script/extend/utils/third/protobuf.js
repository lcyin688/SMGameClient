    ...
    (function prelude(modules, cache, entries) {
        ...
        /* end of prelude */ {
                ...
                function (require, module, exports) {
                    ...
                    function codegen(functionParams, functionName) {
                        ...
                        function Codegen(formatStringOrScope) {
                            ...
                            formatOffset = 0;
                            formatStringOrScope = formatStringOrScope.replace(/%([%dfijs])/g, ($0, $1) => {
                ...
                function (require, module, exports) {
                    ...
                    function genValuePartial_fromObject(gen, field, fieldIndex, prop) {
                        ...
                        if (field.resolvedType) {
                            ...
                            switch (field.type) {
                                ...
                                case 'fixed64':
                                case 'sfixed64':
                                    gen('if(util.Long)')('(m%s=util.Long.fromValue(d%s)).unsigned=%j', prop, prop, isUnsigned)('else if(typeof d%s==="string")', prop)('m%s=parseInt(d%s,10)', prop, prop)(
                                        ...
                                        prop,
                                        prop
                                    )('else if(typeof d%s==="object")', prop)('m%s=new util.LongBits(d%s.low>>>0,d%s.high>>>0).toNumber(%s)', prop, prop, prop, isUnsigned ? 'true' : '');
                                    break;
                                case 'bytes':
                    ...
                    converter.fromObject = function fromObject(mtype) {
                        ...
                        for (var i = 0; i < fields.length; ++i) {
                            ...
                            // Map fields
                            if (field.map) {
                                gen('if(d%s){', prop)('if(typeof d%s!=="object")', prop)('throw TypeError(%j)', field.fullName + ': object expected')('m%s={}', prop)(
                        ...
                        if (normalFields.length) {
                            ...
                            for (i = 0; i < normalFields.length; ++i) {
                                ...
                                if (field.resolvedType instanceof Enum) gen('d%s=o.enums===String?%j:%j', prop, field.resolvedType.valuesById[field.typeDefault], field.typeDefault);
                                    ...
                                    gen('if(util.Long){')('var n=new util.Long(%i,%i,%j)', field.typeDefault.low, field.typeDefault.high, field.typeDefault.unsigned)(
                                    ...
                                    gen('if(o.bytes===String)d%s=%j', prop, String.fromCharCode.apply(String, field.typeDefault))('else{')('d%s=%s', prop, arrayDefault)(
                    ...
                    function decoder(mtype) {
                        ...
                        var gen = util.codegen(['r', 'l'], mtype.name + '$decode')('if(!(r instanceof Reader))')('r=Reader.create(r)')(
                            'var c=l===undefined?r.len:r.pos+l,m=new this.ctor' +
                                (mtype.fieldsArray.filter((field) => {
                                    return field.map;
                                }).length
                                    ? ',k,value'
                                    : '')
                    ...
                    function encoder(mtype) {
                        ...
                        for (var i = 0; i < fields.length; ++i) {
                            ...
                            if (field.map) {
                                ...
                                if (wireType === undefined) gen('types[%i].encode(%s[ks[i]],w.uint32(18).fork()).ldelim().ldelim()', index, ref);
                                // can't be groups
            ...
            17: [
                ...
                { 12: 12, 13: 13, 14: 14, 15: 15, 16: 16, 18: 18, 20: 20, 21: 21, 22: 22, 23: 23, 24: 24, 25: 25, 29: 29, 33: 33, 35: 35, 36: 36, 37: 37, 40: 40, 41: 41 },
            ],
            18: [
                function (require, module, exports) {
                    'use strict';
                ...
                function (require, module, exports) {
                    ...
                    ReflectionObject.prototype.setParsedOption = function setParsedOption(name, value, propName) {
                        ...
                        if (propName) {
                            ...
                            var opt = parsedOptions.find((opt) => {
                        ...
                        return util.Buffer
                            ? function create_buffer_setup(buffer) {
                                  return (Reader.create = function create_buffer(buffer) {
                                      return util.Buffer.isBuffer(buffer) ? new BufferReader(buffer) : /* istanbul ignore next */ create_array(buffer);
                                  })(buffer);
                              }
                            : /* istanbul ignore next */
                              create_array;
                    ...
                    Root.prototype.load = function load(filename, options, callback) {
                        ...
                        function fetch(filename, weak) {
                            ...
                            if (sync) {
                                ...
                                ++queued;
                                self.fetch(filename, (err, source) => {
                                    --queued;
                                    /* istanbul ignore if */
            ...
            32: [
                function (require, module, exports) {
                    ...
                    Service.prototype.rpcCall = function rpcCall(method, requestCtor, responseCtor, request, callback) {
                        ...
                        try {
                            return self.rpcImpl(method, requestCtor[self.requestDelimited ? 'encodeDelimited' : 'encode'](request).finish(), (err, response) => {
                                if (err) {
            ...
            35: [
                ...
                { 12: 12, 13: 13, 14: 14, 15: 15, 16: 16, 20: 20, 21: 21, 23: 23, 25: 25, 27: 27, 33: 33, 37: 37, 40: 40, 41: 41, 42: 42 },
            ],
            36: [
                function (require, module, exports) {
                    'use strict';
                     ...
                     */
                    types.basic = bake([
                        /* double   */ 1, /* float    */ 5, /* int32    */ 0, /* uint32   */ 0, /* sint32   */ 0, /* fixed32  */ 5, /* sfixed32 */ 5, /* int64    */ 0, /* uint64   */ 0, /* sint64   */ 0,
                     ...
                     * @property {number} sfixed64=1 Fixed64 wire type
                     */
                    types.long = bake([0, /* uint64   */ 0, /* sint64   */ 0, /* fixed64  */ 1, /* sfixed64 */ 1], 7);
                    ...
                    types.mapKey = bake(
                        [
                            /* int32    */ 0, /* uint32   */ 0, /* sint32   */ 0, /* fixed32  */ 5, /* sfixed32 */ 5, /* int64    */ 0, /* uint64   */ 0, /* sint64   */ 0, /* fixed64  */ 1, /* sfixed64 */ 1,
                            /* bool     */ 0, /* string   */ 2,
                        ],
                        2
                    );
            ...
            37: [
                function (require, module, exports) {
                    ...
                    util.camelCase = function camelCase(str) {
                        return (
                            str.substring(0, 1) +
                            str.substring(1).replace(camelCaseRe, ($0, $1) => {
            ...
            38: [
                function (require, module, exports) {
                    ...
                    LongBits.prototype.toLong = function toLong(unsigned) {
                        return util.Long ? new util.Long(this.lo | 0, this.hi | 0, Boolean(unsigned)) : /* istanbul ignore next */ { low: this.lo | 0, high: this.hi | 0, unsigned: Boolean(unsigned) };
                    };
