...
var o, n, r, s, a, l, c, h, p = t("../../instance"), u = t("./collider-component");
function d(t, e, i, o) {
i && Object.defineProperty(t, e, {
enumerable: i.enumerable,
configurable: i.configurable,
...
var w = cc._decorator, x = w.ccclass, _ = w.executeInEditMode, B = w.executionOrder, S = w.menu, E = w.property, M = w.help, C = cc.Vec3, A = (o = x("cc.BoxCollider3D"), 
n = B(98), r = S("i18n:MAIN_MENU.component.physics/Collider/Box 3D"), s = M("i18n:COMPONENT.help_url.physics-collider"), 
a = E({
type: cc.Vec3
}), o(l = n(l = r(l = _(l = s(l = (b((c = function(t) {
m(e, t);
function e() {
var e;
d(e = t.call(this) || this, "_size", h, v(e));
e._shape = (0, p.createBoxShape)(e._size);
return e;
}
f(e, [ {
key: "size",
...
return e;
}(u.Collider3D)).prototype, "size", [ a ], Object.getOwnPropertyDescriptor(c.prototype, "size"), c.prototype), 
h = b(c.prototype, "_size", [ E ], {
configurable: !0,
enumerable: !0,
writable: !0,
initializer: function() {
...
var f = cc._decorator, v = f.ccclass, m = f.executeInEditMode, g = f.executionOrder, b = f.menu, w = f.property, x = f.help, _ = v("cc.SphereCollider3D")(o = g(98)(o = b("i18n:MAIN_MENU.component.physics/Collider/Sphere 3D")(o = x("i18n:COMPONENT.help_url.physics-collider")(o = m(o = (y((n = function(t) {
u(e, t);
function e() {
var e;
...
var o, n, r, s, a, l, c, h, p, u, d, y, f, v, m, g = t("./rigid-body-component");
function b(t, e, i, o) {
i && Object.defineProperty(t, e, {
enumerable: i.enumerable,
configurable: i.configurable,
...
var M = cc._decorator, C = M.ccclass, A = M.executeInEditMode, z = M.executionOrder, P = M.menu, F = M.property, T = M.requireComponent, R = M.disallowMultiple, q = M.help, O = cc.Vec3, I = (o = C("cc.ConstantForce"), 
n = z(98), r = T(g.RigidBody3D), s = P("i18n:MAIN_MENU.component.physics/Constant Force 3D"), 
a = q("i18n:COMPONENT.help_url.constantforce"), l = F({
displayOrder: 0
}), c = F({
displayOrder: 1
}), h = F({
...
O.strictEquals(t, O.ZERO) ? this._mask &= ~e : this._mask |= e;
};
x(e, [ {
key: "force",
get: function() {
...
set: function(t) {
O.copy(this._localTorque, t);
this._maskUpdate(this._localTorque, 8);
}
} ]);
return e;
}(cc.Component), y = E(d.prototype, "_force", [ F ], {
configurable: !0,
enumerable: !0,
writable: !0,
initializer: function() {
...
}), m = E(d.prototype, "_localTorque", [ F ], {
configurable: !0,
enumerable: !0,
writable: !0,
initializer: function() {
...
}), E(d.prototype, "force", [ l ], Object.getOwnPropertyDescriptor(d.prototype, "force"), d.prototype), 
E(d.prototype, "localForce", [ c ], Object.getOwnPropertyDescriptor(d.prototype, "localForce"), d.prototype), 
E(d.prototype, "torque", [ h ], Object.getOwnPropertyDescriptor(d.prototype, "torque"), d.prototype), 
E(d.prototype, "localTorque", [ p ], Object.getOwnPropertyDescriptor(d.prototype, "localTorque"), d.prototype), 
d)) || u) || u) || u) || u) || u) || u) || u);
i.ConstantForce = I;
}, {
...
var o, n, r, s, a, l, c, h, p, u, d, y, f, v, m, g, b, w, x, _, B, S, E = t("../instance");
function M(t, e, i, o) {
i && Object.defineProperty(t, e, {
enumerable: i.enumerable,
configurable: i.configurable,
...
var R = cc._decorator, q = R.ccclass, O = R.disallowMultiple, I = R.executeInEditMode, j = R.executionOrder, V = R.menu, N = R.property, k = R.help, L = cc.Vec3, W = (o = q("cc.RigidBody3D"), 
n = j(99), r = V("i18n:MAIN_MENU.component.physics/Rigid Body 3D"), s = k("i18n:COMPONENT.help_url.physics-rigidbody"), 
a = N({
displayOrder: 0
}), l = N({
displayOrder: 1
...
displayOrder: 7
}), o(f = n(f = r(f = s(f = I(f = O(f = (T((v = function(t) {
P(e, t);
function e() {
var e;
...
e._allowSleep = !0;
M(e, "_mass", m, z(e));
M(e, "_linearDamping", g, z(e));
M(e, "_angularDamping", b, z(e));
M(e, "_fixedRotation", w, z(e));
M(e, "_isKinematic", x, z(e));
M(e, "_useGravity", _, z(e));
M(e, "_linearFactor", B, z(e));
M(e, "_angularFactor", S, z(e));
...
T(v.prototype, "linearDamping", [ l ], Object.getOwnPropertyDescriptor(v.prototype, "linearDamping"), v.prototype), 
T(v.prototype, "angularDamping", [ c ], Object.getOwnPropertyDescriptor(v.prototype, "angularDamping"), v.prototype), 
T(v.prototype, "isKinematic", [ h ], Object.getOwnPropertyDescriptor(v.prototype, "isKinematic"), v.prototype), 
T(v.prototype, "useGravity", [ p ], Object.getOwnPropertyDescriptor(v.prototype, "useGravity"), v.prototype), 
T(v.prototype, "fixedRotation", [ u ], Object.getOwnPropertyDescriptor(v.prototype, "fixedRotation"), v.prototype), 
T(v.prototype, "linearFactor", [ d ], Object.getOwnPropertyDescriptor(v.prototype, "linearFactor"), v.prototype), 
T(v.prototype, "angularFactor", [ y ], Object.getOwnPropertyDescriptor(v.prototype, "angularFactor"), v.prototype), 
m = T(v.prototype, "_mass", [ N ], {
configurable: !0,
enumerable: !0,
writable: !0,
initializer: function() {
...
}), g = T(v.prototype, "_linearDamping", [ N ], {
configurable: !0,
enumerable: !0,
writable: !0,
initializer: function() {
...
}), b = T(v.prototype, "_angularDamping", [ N ], {
configurable: !0,
enumerable: !0,
writable: !0,
initializer: function() {
...
}), w = T(v.prototype, "_fixedRotation", [ N ], {
configurable: !0,
enumerable: !0,
writable: !0,
initializer: function() {
...
}), x = T(v.prototype, "_isKinematic", [ N ], {
configurable: !0,
enumerable: !0,
writable: !0,
initializer: function() {
...
}), B = T(v.prototype, "_linearFactor", [ N ], {
configurable: !0,
enumerable: !0,
writable: !0,
initializer: function() {
...
}), S = T(v.prototype, "_angularFactor", [ N ], {
configurable: !0,
enumerable: !0,
writable: !0,
initializer: function() {
...
keywords: [ "cannon.js", "cocos", "creator", "physics.dbe2a", "engine", "3d" ],
scripts: {
...
A.COMPOUND, A.CONVEXPOLYHEDRON, this.bins), T = this.binLengths, R = this.bins.length, q = 0; q !== R; q++) T[q] = 0;
var O = Math.ceil;
...
switch (j.type) {
case z:
var V = it.position.x, N = it.position.y, k = it.position.z, L = j.radius;
I(V - L, N - L, k - L, V + L, N + L, k + L, it);
break;
...
var A = new i(), z = new i(), P = new i(), F = new i(), T = new i(), R = new i(), q = (new a(), 
[]), O = new n();
l.prototype.intersectTrimesh = function(t, e, i, o, r, s) {
var a = A, l = q, c = O, h = C, p = z, u = P, y = F, f = R, w = T, x = (s && s.faceList, 
...
t.getVertex(x[3 * j], m);
m.vsub(u, h);
var V = p.dot(a), N = a.dot(h) / V;
if (!(N < 0)) {
p.scale(N, v);
v.vadd(u, v);
t.getVertex(x[3 * j + 1], g);
t.getVertex(x[3 * j + 2], b);
var k = v.distanceSquared(u);
...
f.length;
for (var T = z.length, R = 0; R < T; R++) {
var q = this.vertices[z[R]], O = this.vertices[z[(R + 1) % T]];
q.vsub(O, l);
c.copy(l);
i.vmult(c, c);
e.vadd(c, c);
...
var s = t.vertices.length, a = T, l = 0, c = 0, h = R, p = t.vertices;
h.setZero();
...
var B = new s(), S = new s(), E = (new s(), new s()), M = new s(), C = new s(), A = new s(), z = new s(), P = new s(), F = new s(), T = new s(), R = new s(), q = new s(), O = new s(), I = new i(), j = [];
u.prototype[n.types.SPHERE | n.types.TRIMESH] = u.prototype.sphereTrimesh = function(t, e, i, o, n, s, l, c, h, p, u) {
var d = C, y = A, f = z, v = P, m = F, g = T, b = I, w = M, x = S, _ = j;
a.pointToLocalFrame(o, s, i, m);
var V = t.radius;
b.lowerBound.set(m.x - V, m.y - V, m.z - V);
b.upperBound.set(m.x + V, m.y + V, m.z + V);
e.getTrianglesInAABB(b, _);
for (var N = E, k = t.radius * t.radius, L = 0; L < _.length; L++) for (var W = 0; W < 3; W++) {
e.getVertex(e.indices[3 * _[L] + W], N);
N.vsub(m, x);
if (x.norm2() <= k) {
w.copy(N);
a.pointToWorldFrame(o, s, w, N);
N.vsub(i, x);
if (u) return !0;
...
var V = new s(), N = new s(), k = new s(), L = new s(), W = new s();
...
for (var I = p.get(), j = J, V = 0; 2 !== V && !y; V++) for (var N = 0; 2 !== N && !y; N++) for (var k = 0; 2 !== k && !y; k++) {
I.set(0, 0, 0);
V ? I.vadd(u[0], I) : I.vsub(u[0], I);
N ? I.vadd(u[1], I) : I.vsub(u[1], I);
k ? I.vadd(u[2], I) : I.vsub(u[2], I);
o.vadd(I, j);
j.vsub(i, j);
if (j.norm2() < d * d) {
if (h) return !0;
...
for (V = 0; V !== U && !y; V++) for (N = 0; N !== U && !y; N++) if (V % 3 != N % 3) {
u[N].cross(u[V], L);
L.normalize();
u[V].vadd(u[N], W);
O.copy(i);
...
i.vsub(E, z);
if (A < 0 && z.dot(S) > 0) {
for (var P = [], F = 0, T = B.length; F !== T; F++) {
var R = p.get();
r.vmult(y[B[F]], R);
o.vadd(R, R);
P.push(R);
...
this.dt = t;
var e, i = this.contacts, o = T, n = R, r = this.numObjects(), s = this.bodies, a = this.solver, l = this.gravity, c = this.doProfiling, h = this.profile, p = u.DYNAMIC, d = this.constraints, y = F, f = (l.norm(), 
l.x), v = l.y, m = l.z, b = 0;
c && (e = performance.now());
...
var j = (L = i[I]).bi, V = L.bj, N = L.si, k = L.sj;
N.material && k.material ? N.material.restitution >= 0 && k.material.restitution >= 0 && (L.restitution = N.material.restitution * k.material.restitution) : j.material && V.material && j.material.restitution >= 0 && V.material.restitution >= 0 && (L.restitution = j.material.restitution * V.material.restitution);
a.addEquation(L);
...
this.shapeOverlapKeeper.set(N.id, k.id);
}
